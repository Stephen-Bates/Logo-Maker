...
describe('Shapes', () => {
    describe('Circle', () =>{
        it('should output an XML string defining an SVG image of a blue circle', () => {
            ...
            expect(circle.render()).isEquel('<circle cx="" cy="" r="10" fill="blue" />')
        })
    })
    describe('Triangle', () =>{
        it('should output an XML string defining an SVG image of a blue triangle', () => {
            ...
            expect(triangle.render()).isEquel('<polygon points="150, 18 244, 182 56, 182" fill="blue" />')
        })
    })
    describe('Square', () =>{
        it('should output an XML string defining an SVG image of a blue square', () => {
            ...
            expect(square.render()).isEquel('<rect x="75" y="25" width="150" height="150" fill="blue" />')
        })
    })
})